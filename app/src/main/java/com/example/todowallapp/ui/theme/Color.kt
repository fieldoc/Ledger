...
val PlanAccent = Color(0xFFA8D5BA)            // Soft sage green for day organizer plan blocks
...
val LightPlanAccent = Color(0xFF66BB6A)       // Richer sage green for light mode day organizer
